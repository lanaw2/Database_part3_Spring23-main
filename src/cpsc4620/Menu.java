...
public class Menu {
	...
	public static void EnterOrder() throws SQLException, IOException {
		...
		if (add_discount.equals("Y")) {
			...
			while (add_more_discount) {
				...
				System.out.println(
						"Which order discount would you like to add? Enter the DiscountID. Enter -1 to stop adding discounts.");
		...
		Order o = null;
		if (orderType == 1) {
			o = new DeliveryOrder(orderNumber, CustID, formatter.format(date), orderCustPrice, orderBusPrice, 0,
					address);
			...
			o = new DineinOrder(orderNumber, CustID, formatter.format(date), orderCustPrice, orderBusPrice, 0,
					table_num);
	...
	public static Pizza buildPizza(int orderID) throws SQLException, IOException {
		...
		SimpleDateFormat formatter = new SimpleDateFormat("YYYY-MM-DD HH:mm:ss");
		Date date = new Date();
		Pizza p = new Pizza(DBNinja.getMaxPizzaID() + 1, size_str, crust_str, orderID, "Completed", date.toString(),
				BusPrice, CustPrice);
		...
		while (add_topp) {
			...
			DBNinja.printInventory();
			System.out.println(
					"Which topping would you like to add? Enter Topping ID Number, Enter -1 to stop adding toppings:");
			Integer top_ID = Integer.parseInt(reader.readLine());
			if (top_ID == -1) {
				add_topp = false;
				break;
	...
	public static void PrintReports() throws SQLException, NumberFormatException, IOException {
		...
		BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
		System.out.println(
				"Which report would you like to print? Enter a number: \n(1) ToppingPopularity\n(2) ProfitByPizza\n(3) ProfitByOrderType");
